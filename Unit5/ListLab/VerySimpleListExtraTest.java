...
//testing class built by Huo Chen; Last Update 2/15/2023
import java.util.Arrays;
 
public class VerySimpleListExtraTest {
    public static void main(String[] args) {
      ...
      System.out.println();
      System.out.print("Testing Sortable interface implementation...");
      Sortable ls1 = new VerySimpleList();
      System.out.println("Pass");
      

      ((VerySimpleList)ls1).add("D");
      ((VerySimpleList)ls1).add("B");
      ((VerySimpleList)ls1).add("C");
      ((VerySimpleList)ls1).add("A");

      System.out.println();
      System.out.print("Testing SortAsc method...");
      ((VerySimpleList)ls1).sortAsc();
      l2 = ((VerySimpleList)ls1).getArray();
      if(l2[0].equals("A") && l2[1].equals("B") && l2[2].equals("C") && l2[3].equals("D") && l2[4]==null && l2[5]==null && l2[6]==null && l2[7]==null && l2[8]==null && l2[9]==null){
          System.out.println("Pass");
      }else{
          System.out.println("Failed");
          System.out.println("Expected Array: [A, B, C, D, null, null, null, null, null, null]");
          System.out.println("Your Array: " + Arrays.toString(l2));
      }

      ((VerySimpleList)ls1).clear();
      ((VerySimpleList)ls1).add("D");
      ((VerySimpleList)ls1).add("B");
      ((VerySimpleList)ls1).add("C");
      ((VerySimpleList)ls1).add("A");
      ...
      System.out.println();
      System.out.print("Testing SortDsc method...");
      ((VerySimpleList)ls1).sortDes();
      l2 = ((VerySimpleList)ls1).getArray();
      if(l2[0].equals("D") && l2[1].equals("C") && l2[2].equals("B") && l2[3].equals("A") && l2[4]==null && l2[5]==null && l2[6]==null && l2[7]==null && l2[8]==null && l2[9]==null){
          System.out.println("Pass");
      }else{
          System.out.println("Failed");
          System.out.println("Expected Array: [D, C, B, A, null, null, null, null, null, null]");
          System.out.println("Your Array: " + Arrays.toString(l2));
      }
